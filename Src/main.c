...
LineStruct line_char;
char temp[1] ;
temp[0]= 'H';
//hd44780_clr_disp(0x21);
hd44780_write_message_at(0x21, "TEXT", 0, 0, true);
line_char = hd44780_read_bulk_bytes(0x21,0,0,true);
hd44780_set_line(0x21, 3, 0, false);
hd44780_write_bulk_bytes(0x21, line_char.array, 19);
//hd44780_write_character_at(0x21,temp[0],3 ,18,0);
